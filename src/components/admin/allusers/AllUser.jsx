...
import { useGetRiderDataQuery } from '../../../services/adminapi';
...
const AllUser = () => {
  ...
  const { data, isSuccess, isError } = useGetRiderDataQuery()
  ...
  return (
    ...
    <Table sx={{ minWidth: 650 }} aria-label="simple table">
      ...
      <StyledTableCell align="center">{element.f_name}</StyledTableCell>
      <StyledTableCell align="center">{element.l_name}</StyledTableCell>
